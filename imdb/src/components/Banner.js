...
function Banner() {
    const [movie, setMovie] = useState({}) // array used to collect movies from backend api 
    useEffect(function() {
        axios.get("https://api.themoviedb.org/3/trending/movie/week?api_key=5c1d2ae64af71d54618f677b6890b38c&page=1").then((res) => {
